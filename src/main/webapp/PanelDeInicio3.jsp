...
<body>
            ...
            <div class="tab-content">
                <div id="signup" class="container tab-pane active">
                    ...
                    <form id="registrationForm">
                        <div class="form-row">
                            <input type="hidden" name="edicionId" id="edicionId" value="${edicionId}">
    ...
    $(document).ready(function() {
        $('#registrationForm').submit(function(event) {
            ...
            $.ajax({
                type: "POST",
                url: "inscripcionAgregarNuevo", // Asegúrate de poner aquí la URL correcta del Servlet que maneja el registro
                data: formData,
                success: function(response) {
                    alert('Registrado con éxito!'); // Puedes cambiar esto por cualquier elemento de la UI que prefieras
                },
                error: function() {
                    alert('Error al registrar. Inténtalo de nuevo.'); // Puedes cambiar esto por cualquier elemento de la UI que prefieras
                }
            });
        });
    });
