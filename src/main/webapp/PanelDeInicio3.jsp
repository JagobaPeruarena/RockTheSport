...
<body>
  ...
  <div class="event-content">
    <div class="event-description">
      ...
      <p>Descripción detallada del evento. Información relevante sobre el evento, como horarios, ubicación, participantes, etc.</p>
    </div>
        ...
        <div id="login" class="container tab-pane fade"><br>
          ...
          <form action="#">
            <div class="form-group">
              <label for="dni">DNI:</label>
              <input type="text" class="form-control" id="dni" placeholder="Introduce tu DNI" name="dni">
            </div>
