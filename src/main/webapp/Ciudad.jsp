        ...
        <div class="modal-body">
          ...
          <form>
            ...
            <div class="form-group">
              ...
              <input type="number" class="form-control" id="editPoblacion">
            </div>
          </form>
        </div>
        ...
        <div class="modal-body">
          ...
          <form>
            ...
            <div class="form-group">
              ...
              <input type="text" class="form-control" id="addUbicacion">
            </div>
            <div class="form-group">
              <label for="addPoblacion">Población</label>
              <input type="number" class="form-control" id="addPoblacion">
            </div>
          </form>
        </div>
        <div class="modal-footer">
