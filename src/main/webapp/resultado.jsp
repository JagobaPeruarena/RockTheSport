					...
					<tbody>
						<c:forEach items="${resultados}" var="resultados">
							<tr>
								...
								<td>${resultados.inscripcion.dorsal}</td>
								<td>
		...
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				...
				<div class="modal-body">
					...
					<form action="resultadoEditar" var="resultado" method="post">
						<input type="hidden" name="editId" id="editId"
							value="${resultado.id}">
						<div class="form-group">
							<label for="editTiempo">Tiempo</label> <input type="text"
								class="form-control" id="editTiempo">
						</div>
						<div class="form-group">
		...
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				...
				<div class="modal-body">
					...
					<form>
						<div class="form-group">
							<label for="addTiempo">Tiempo</label> <input type="text"
								class="form-control" id="addTiempo">
						</div>
						<div class="form-group">
