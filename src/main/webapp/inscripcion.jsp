        ...
        <div class="modal-body">
          ...
          <form>
            <div class="form-group">
              ...
              <input type="text" class="form-control" id="editDorsal">
            </div>
            <div class="form-group">
              <label for="editFechaInscripcion">Fecha de Inscripción</label>
              <input type="date" class="form-control" id="editFechaInscripcion">
            </div>
            <div class="form-group">
              <label for="editIdDeportista">ID Deportista</label>
              <input type="text" class="form-control" id="editIdDeportista">
            </div>
            <div class="form-group">
              <label for="editIdEdicion">ID Edición</label>
        ...
        <div class="modal-body">
          ...
          <form>
            <div class="form-group">
              ...
              <input type="text" class="form-control" id="addDorsal">
            </div>
            <div class="form-group">
              <label for="addFechaInscripcion">Fecha de Inscripción</label>
              <input type="date" class="form-control" id="addFechaInscripcion">
            </div>
            <div class="form-group">
              <label for="addIdDeportista">ID Deportista</label>
              <input type="text" class="form-control" id="addIdDeportista">
            </div>
            <div class="form-group">
              <label for="addIdEdicion">ID Edición</label>
